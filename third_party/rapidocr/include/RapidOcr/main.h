...
const char *usageMsg = "(-d --models) (-1 --det) (-2 --cls) (-3 --rec) (-4 --keys) (-i --image)\n"\
                       ...
                       "[-a --noAngle] [-A --mostAngle] [-P --provider]\n\n";
...
const char *optionalMsg = "-t --numThread: value of numThread(int), default: 4\n" \
                          ...
                          "-P --provider: select Provider type:MNN/Ncnn/Onnx\n\n";

const char *otherMsg = "-v --version: show version\n" \
                       "-h --help: print this help\n\n";

const char *example1Msg = "Example1: %s --models models --det det --cls cls --rec rec --keys keys.txt --image 1.jpg --P Onnx\n";
const char *example2Msg = "Example2: %s -d models -1 det -2 cls -3 rec -4 keys.txt -i 1.jpg -t 4 -p 50 -s 0 -b 0.6 -o 0.3 -u 2.0 -a 1 -A 1 -P Onnx\n";
