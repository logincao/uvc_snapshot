...
MNNAngleNet::~MNNAngleNet() {
}

void MNNAngleNet::setNumThread(int numOfThread) {
...
void MNNAngleNet::initModel(const std::string &pathStr) {
...
Angle MNNAngleNet::getAngle(cv::Mat &src) {
...
std::vector<Angle> MNNAngleNet::getAngles(std::vector<cv::Mat> &partImgs, const char *path,
